...
url = f'https://www.ceneo.pl/{a}#tab=reviews'
all_opinions = []
while(url):
    ...
    for opinion in opinions:
        ...
        useless = opinion.select_one("button.js_vote-no > span").get_text().strip()
...
with open(f"opinions/{a}.json", "w", encoding="UTF-8") as jf:
