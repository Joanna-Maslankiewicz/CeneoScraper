...
|dla ilu osób nieprzydatna|button.js_vote-no > span|useless||
...
2. Zapisanie wszystkich elementów pojedynczdej opiniii do jednej zmiennej \(słownik\)
3. Pobranie wszystkich opinii z pojedynczej strony do słowników i dodanie ich do listy
4. Pobranie wszystkich opinii o produkcje z wszystkich stron i zapisanie ich do pliku .json
